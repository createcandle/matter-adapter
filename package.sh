...
python3.11 -m pip install home-assistant-chip-core -t lib --prefix "" --no-cache-dir --upgrade
...
cp -r lib pkg LICENSE manifest.json *.py README.md thread css images js views  package/
